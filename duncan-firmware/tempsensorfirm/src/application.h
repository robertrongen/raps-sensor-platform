...
typedef struct {
   ...
   uint64_t  TEMPRRATURE_UPDATE_SERVICE_INTERVAL;
   uint64_t  TEMPERATURE_UPDATE_NORMAL_INTERVAL;
   uint64_t  HUMIDITY_UPDATE_SERVICE_INTERVAL;
   uint64_t  HUMIDITY_UPDATE_NORMAL_INTERVAL;
   uint64_t  LUX_METER_UPDATE_SERVICE_INTERVAL;
   uint64_t  LUX_METER_UPDATE_NORMAL_INTERVAL;
